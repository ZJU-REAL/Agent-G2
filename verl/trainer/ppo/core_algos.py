...
def compute_policy_loss(
    ...
    Args:
        ...
        loss_remove_clip (bool, optional):
            If True, use the unclipped policy-gradient objective. This matches
            the TRAPO/Dr.GRPO training setup used by the released TRAPO script.
    """

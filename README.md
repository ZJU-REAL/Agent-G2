<h1 align="center">
  <img src="assets/Agent-G2_logo.png" alt="Agent-G2 logo" width="42%"><br>
  Agent-G2
</h1>
<h3 align="center"><em>Gaussian Guidance for Agentic Reinforcement Learning</em></h3>
...
- **Gaussian guidance instead of scalar scheduling.** Agent-G2 models useful
...
- **Strong long-horizon performance.** Agent-G2 reaches 95.3% / 98.4% success on
...
<p align="center">
  <img src="assets/agent_g2_pipeline_web.png" alt="Agent-G2 training pipeline" width="90%">
</p>

Agent-G2 operates in four stages:
...
3. **Per-task prefix sampling.** For each task, Agent-G2 samples a guidance ratio
